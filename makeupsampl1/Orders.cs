...
namespace MakeUp
{
    public partial class Orders : Form
    {
        ...
        {
            var customers = context.Customers.Select(v => new AutoCompleteViewModel { Value = v.Id, Text = v.Ferstname }).ToList();
        ...
        {
            var registerDateTime = DateTime.Now;

            var orderNumber = context.Orders
                .Where(x => DbFunctions.TruncateTime(x.RegisterDateTime) == DbFunctions.TruncateTime(DateTime.Now))
