...
namespace MakeUp
{
    public partial class Users : Form
    {
        ...
        {
            if (dgvUsers.Columns[e.ColumnIndex].Name == "CustomerID")
            {
                string oldCustomerID = (string)dgvUsers.Rows[e.RowIndex].Cells[e.ColumnIndex].Value;
                string newCustomerID = dgvUsers.CurrentCell.EditedFormattedValue.ToString();
